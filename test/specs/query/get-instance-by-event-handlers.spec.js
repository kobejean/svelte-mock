...
const Paragraph = resolveDefault(
    jest.requireMock(getFixturePath('Paragraph.svelte')));
svelteMock.mockImplementation(Paragraph);

const EventHandlers = resolveDefault(
    jest.requireActual(getFixturePath('EventHandlers.svelte')));
